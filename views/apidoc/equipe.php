<div class="d-flex flex-column justify-content-center vh-100 align-items-center">
    <div class="card col-xl-7  col-lg-9 col-md-10 col-12">
        <div class="card-body">
            <h5 class="card-title">
                Liste des équipes
                <?php if ($hackathon != null) { ?> pour le hackathon « <?= $hackathon['thematique'] ?> » <?php } ?>
            </h5>
            <table class="table card-text">
                ...
                <?php foreach ($data as $equipe) { ?>
                    <tr>
                        ...
                        <td><?= $equipe['nbparticipants'] ?></td>
                        <td>
                            <a class="btn btn-sm btn-primary"
                               href="<?= "/sample/membres?idequipe={$equipe['idequipe']}" ?>">
                                Les membres
                            </a>
                        </td>
                    </tr>
